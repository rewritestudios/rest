import { FetchOptions, RetryOptions } from "./types";

export const createURL = (route: string, query?: FetchOptions['query'], baseURL = 'https://api.userewrite.me') => {
...
export const isRetryableStatus = (status: number) => RETRYABLE_STATUS.includes(status);
